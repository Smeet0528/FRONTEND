...
import MemberList from '@/components/ChatPage/MemberList';
...
export default function ChatPage({ title }: ChatPageProps) {
  ...
  const members = ['김즈에', '이재연'];

  return (
    <div className="w-full min-h-screen flex justify-center bg-[#FFF1F1] font-[pretendard]">
      <div className="w-full max-w-[480px] h-screen flex flex-col relative bg-[#FFF1F1] ">
        ...
        {/* 입력창 */}
        <div className="fixed bottom-0 inset-x-0 mx-auto w-full max-w-[480px] px-6 py-4 flex items-center gap-3 z-30 bg-[#FFF1F1]">
