...
return (
  <div className="w-full flex justify-center bg-[#F8F8F8] min-h-screen">
    <div className="w-full max-w-[480px] bg-[#F8F8F8]">
      ...
      <form className="px-6 flex flex-col gap-6 pb-36" onSubmit={handleSubmit}>
        <StudyTitleInput value={title} onChange={handleChange} />
        <StudyIntroTextarea value={intro} onChange={handleChange} />

        <div className="flex flex-col justify-start items-start w-full gap-2">
          <p className="text-base font-semibold text-[#2C2C2C]">스터디 기간</p>
        ...
        <div className="flex flex-col justify-start items-start w-full gap-2">
          <p className="text-base font-semibold text-[#2C2C2C]">스터디 요일</p>
        ...
        <div className="flex flex-col justify-start items-start gap-2">
          ...
          <div className="flex gap-2 flex-wrap">
            ...
            {selectedKeywords.length < 3 && (
              ...
              >
                <img src={PlusIcon} alt="추가" className="w-[16px] h-[16px]" />
              </button>
            )}
          </div>
        </div>
